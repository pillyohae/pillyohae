package com.example.main.survey.service;

import com.example.common.survey.entity.Survey;
import com.example.common.user.entity.User;
import com.example.main.survey.dto.SurveyDetailsDto;
import com.example.main.survey.dto.SurveyResponseDto;
import com.example.main.survey.dto.SurveySubmitRequestDto;
import com.example.main.survey.dto.SurveySubmitResponseDto;
import com.example.main.survey.repository.SurveyRepository;
...
public class SurveyService {
    ...
    public SurveySubmitResponseDto create(String email, SurveySubmitRequestDto requestDto) {
        ...
        Survey savedSurvey = new Survey(user, requestDto.getAge(),requestDto.getGender(),requestDto.getHeight(),requestDto.getWeight(),requestDto.getHealthGoals(),requestDto.getHealthCondition(),requestDto.getLifestyle());

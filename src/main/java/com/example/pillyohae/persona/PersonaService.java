...
public class PersonaService {
    ...
    public Image generatePersonaFromProduct(String productImageUrl) {
        ...
        log.info("productDescription : {}, productImageUrl: {}", productDescription,
            productImageUrl);
    ...
    private String analyzeProductImage(String imageUrl) {
        ...
        try {
            userMessage = new UserMessage(
                "Please explain the main characteristics by analyzing only the product excluding the background from the product image.",
